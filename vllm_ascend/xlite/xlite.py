...
class XliteWrapper:
    ...
    def __init__(self, runnable: nn.Module, vllm_config: VllmConfig, device: torch.device) -> None:
        ...
        self.attn_metadata_router = AttnMetadataRouter(attn_metadata=None, device="cpu")
        ...
        **model_kwargs: dict[str, Any],
        ...
        Args:
            ...
            inputs_embeds (Optional[torch.Tensor]): Optional external input embeddings (e.g. multimodal/deepstack
                scenarios).
            **model_kwargs (dict[str, Any]): Additional keyword arguments for the runnable.
        ...
        attn_metadata_router = self.attn_metadata_router
        attn_metadata_router.attn_metadata = attn_metadata
